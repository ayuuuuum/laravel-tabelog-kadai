...
@section('content')
    ...
    {{--「パスワード更新」ボタンをクリックすることでmypage.update_passwordのrouteを呼び出す--}}
   <form method="post" action="{{route('mypage.update_password')}}">
       ...
       <div class="form-group row mb-4">
           ...
           <div class="col-md-7">
               <input id="password-confirm" type="password" class="form-controlsamuraimart-login-input" name="password_confirmation" required autocomplete="new-password">
           </div>
       </div>
