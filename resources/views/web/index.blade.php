        ...
        <div class="col">
            ...
            <h2>おすすめ店舗</h2>
                ...
                @if ($recommended_shop->image !== "")
                    <img src="{{ asset('storage/img/' . $recommended_shop->image) }}" class="img-thumbnail samuraimart-product-img-detail">
            ...
            @foreach ($recently_shops as $recently_shop)
                <div class="col-md-3">
                    <a href="{{ route('shops.show', $recently_shop) }}">
                        ...
                        <img src="{{ asset('storage/img/' . $recently_shop->image) }}" class="img-thumbnail samuraimart-product-img-detail">
                        @else
